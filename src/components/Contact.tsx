...
export function Contact() {
  ...
  const socialLinks = [
    ...
    // {
    //   name: 'X/Twitter',
    //   url: 'https://twitter.com/mahmoudmagdy',
    //   icon: Phone,
    //   color: 'hover:text-blue-400',
    // },
    // {
    //   name: 'Facebook',
    //   url: 'https://facebook.com/mahmoudmagdy',
    //   icon: Facebook,
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg border border-yellow-200 dark:border-yellow-800">
                <p className="text-yellow-800 dark:text-yellow-200 text-sm text-center">
                  <strong>Note:</strong> If the form isn't working, please reach out to me directly at{' '}
                  <a href="mailto:mmataghian@gmail.com" className="text-green-700 dark:text-green-400 hover:underline font-medium">
                    mmataghian@gmail.com
                  </a>{' '}
                  or through the contact methods listed on the right.
                </p>
              </div>
            </form>
          </motion.div>
          ...
          >
            ...
            <div className="mt-8 p-6 bg-green-50 dark:bg-green-900 rounded-lg">
              <h4 className="text-lg font-bold text-green-900 dark:text-green-100 mb-2">Quick Response</h4>
              <p className="text-green-800 dark:text-green-200 text-sm">
                I typically respond within 24 hours. For urgent matters, please reach out via WhatsApp or Email.
              </p>
            </div>
          </motion.div>
        </div>
